...
우리 프로젝트의 안전한 진행을 위해, 코드 작업 전 반드시 아래의 규칙을 확인해 주세요. 
...
### 2. 브랜치(Branch) 이름 규칙
누가 어떤 작업을 하는 브랜치인지 알아보기 쉽게 통일합니다.
👉 **형식: `작업종류/기능이름`** (영문 소문자 사용, 띄어쓰기는 `-` 사용)

* `feat/login` : 로그인 기능 추가 작업
* `fix/header-bug` : 헤더 버그 수정 작업
* `docs/readme` : 문서 작성 작업
